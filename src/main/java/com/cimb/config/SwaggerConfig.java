...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Rest API for Banking Application")
                .description("This is an API which performs banking operations")
                .contact(new Contact("Mohammed Irfan", null, "irfan.mukthar29@gmail.com"))
